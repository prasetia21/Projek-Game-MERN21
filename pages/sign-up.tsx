	...
	return (
        ...
        <div className="container mx-auto">
            <form action="">
                ...
                <div className="pt-50">
                    <label for="name" className="form-label text-lg fw-medium color-palette-1 mb-10">Full Name</label>
                ...
                <div className="pt-30">
                    <label for="password" className="form-label text-lg fw-medium color-palette-1 mb-10">Password</label>
